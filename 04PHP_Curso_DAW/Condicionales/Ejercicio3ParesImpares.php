...
<body style="text-align: center; background-color: #ded6c9">
    <h2>Ejercicio 3</h2>
    <p>Introduce un numero para saber si es PAR o IMPAR</p>
    <form action="Ejercicio3Condicionales.php" method="post">
    ...
    <?php
        if (!empty($_POST['numero'])) {
            ...
            echo "<p>no has introducido nada... Vuelve a probar</p>";
        }
    ?>
</body>
