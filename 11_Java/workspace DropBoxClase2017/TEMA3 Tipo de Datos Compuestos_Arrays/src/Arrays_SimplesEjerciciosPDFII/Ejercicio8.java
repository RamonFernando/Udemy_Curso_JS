...
public class Ejercicio8 {
	...
	public static void main(String[] args) {
		...
		int humedad[] = { 45, 40, 40, 40, 37, 35, 39, 39, 45, 50, 55, 60, 65,
		...
		System.out
				.println("*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*==*=*=*=*=*=*=*=*=*=*\n");
		System.out.println("La humedad es de: " + "\"" + humedad[posMin] + "\""
				+ " y es a la " + "\"" + horas[posMin] + "\"" + " hora.");
		System.out.println("La humedad es de: " + "\"" + humedad[posMax] + "\""
				+ " y es a la " + "\"" + horas[posMax] + "\"" + " hora.");
		System.out
				.println("\n*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*==*=*=*=*=*=*=*=*=*=*");
