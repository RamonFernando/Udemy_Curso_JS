 ...
 *
 */
public class Ejercicio6posMinposMax {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out.println("La menor votacion es: " + "\"" + votos[posMin]
				+ "\"" + " y fue la " + (posMin + 1) + "º en introducirse.");
		System.out.println("La mayor votacion es: " + "\"" + votos[posMax]
				+ "\"" + " y fue la " + (posMax + 1) + "º en introducirse.");
		System.out
				.println("\n*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*==*=*=*=*=*=*=*=*=*=*");
