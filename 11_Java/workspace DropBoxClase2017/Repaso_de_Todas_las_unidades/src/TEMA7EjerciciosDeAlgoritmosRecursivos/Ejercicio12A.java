...
public class Ejercicio12A {
	...
	public static void main(String[] args) {
		...
		System.out.println(esPalindromo(ejemplo1, 0, ejemplo1.length - 1));
		System.out.println(esPalindromo(ejemplo2, 0, ejemplo2.length - 1));
	...
	public static boolean esPalindromo(char[] frase, int inicio, int fin) {
		...
		} else if (frase[inicio] == frase[fin]
